...
public final class PlayerRepository {
    ...
    public static @NotNull CompletableFuture<@NotNull Void> update(@NotNull PlayerModel updatedPlayer) {
        return CompletableFuture.runAsync(() ->
                HibernateUtil.getSessionFactory().inTransaction(session -> session.merge(updatedPlayer))
        );
    }
}
